...
$("#submit-records").on("click", async function () {
    ...
    if (!wasErrorWhenInserting) {
        modal("success", `Successfully submitted new admins! Please wait...`);
    } else {
        modal("error", `Unable to submit one or more admins. Please check the console for errors.`);
    }
});
