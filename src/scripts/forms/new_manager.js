...
$("#submit-records").on("click", async function () {
    ...
    if (!wasErrorWhenInserting) {
        modal("success", `Successfully submitted new managers! Please wait...`);
    } else {
        modal("error", `Unable to submit one or more managers. Please check the console for errors.`);
    }
});
